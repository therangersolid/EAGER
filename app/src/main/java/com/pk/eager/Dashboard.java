...
//        Log.d(TAG, "longitude" + location.getLongitude());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_nearbyIncident) {
            ...
            Intent intent = new Intent(dashboard, Activity_Contact.class);
            dashboard.startActivity(intent);
        } else if (id == R.id.nav_location) {
            Intent intent = new Intent(dashboard, Activity_LocationUsingLocationAPI.class);
            dashboard.startActivity(intent);
        } else if (id == R.id.nav_soundbutton) {
            Intent intent = new Intent(dashboard, Activity_SoundButton.class);
            dashboard.startActivity(intent);
